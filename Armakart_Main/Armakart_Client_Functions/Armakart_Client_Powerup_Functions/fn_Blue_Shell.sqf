...
["Armakart", "MyKey", "Powerup Action", {
	...
	[] Spawn {
		...
		////////////////////////////////////////////////////////////////////////////////////////////////
			...
			_First_Boi_vic_pos_z = _First_Boi_vic_pos_z + 685;

			_x_pos = random 2;
			_y_pos = random 4;

			[[_First_Boi_vic_pos_x,_First_Boi_vic_pos_y,_First_Boi_vic_pos_z], "ammo_Missile_Cruise_01", _First_Boi_vic, 115, false, [_x_pos,_y_pos,2]] remoteExec ["BIS_fnc_exp_camp_guidedProjectile", 2];
