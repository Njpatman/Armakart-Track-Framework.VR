...
if (isServer) then 
{
	...
	{CP_NUM = CP_NUM + 1} forEach (allMissionObjects "VR_3DSelector_01_complete_F");

	publicVariable "CP_NUM";

	SUB_CP_NUM = 0;

	{SUB_CP_NUM = SUB_CP_NUM + 1} forEach (allMissionObjects "Sign_Arrow_Large_Cyan_F");

	publicVariable "SUB_CP_NUM";
