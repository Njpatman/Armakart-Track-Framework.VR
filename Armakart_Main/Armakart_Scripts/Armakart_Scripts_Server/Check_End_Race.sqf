...
while {RACE_IN_PROGRESS} do
{
	...
	if (KARTS_FINISHED > 0 && !(NO_LOOPING)) then
	{
		...
		[] Spawn 
		{
			...
			["|Armakart System| : Someone has completed the race, Racers have 3 minutes and 15 seconds to finish!"] remoteExec ["systemChat", 0];
			...
			["|Armakart System| : 2 minutes and 30 seconds until race end!"] remoteExec ["systemChat", 0];
